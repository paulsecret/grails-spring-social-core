 ...
 * Helper methods.
 */
public final class SpringSocialUtils {

    private static ConfigObject config;

    private SpringSocialUtils() {
        // static only
    }
    ...
    public static void reloadConfig() {
        mergeConfig(ReflectionUtils.getConfig(), "DefaultSpringSocialConfig");
    }
    ...
    private static void mergeConfig(final ConfigObject currentConfig, final String className) {
        GroovyClassLoader classLoader = new GroovyClassLoader(SpringSocialUtils.class.getClassLoader());
